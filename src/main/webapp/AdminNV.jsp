...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/plistuseropper.js@1.14.7/dist/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
    ...
    <div id="main">
        ...
        <div class="content  p-0">
            <div class="content-nav">
                <a href="UserControllerServlet?mod2=1&iduser=<%=user.getID_User()%>&Role=<%=role%>" class="btn content-btn m-t-60">MENU</a><br>
                    ...
                    <form action="UserControllerServlet" method="post">
                        <div class="drink content-menu">
                            <select name="typeSearch" class="select_drink">
                                <option value="ID_User">MaNhanVien</option>
                            ...
                            <input class="content-input" type="text" name="txt_search" id="" placeholder="Enter string search?">
